...
const TaskItem = (props:TaskItemProps)=>{
    ...
    return drag(
        <div  className=" my-3 max-w-72 drop-shadow-lg bg-white cursor-pointer rounded-md p-2">
            ...
            <span className="bg-blue-200 text-blue-600 py-1 font-medium text-sm px-1.5 rounded-md" >Feature</span>
            <div className="flex text-sm items-center">
            <span className="md:p-0 pl-1" title=" Due on Feb 2022">
            <ScheduleOutlined style={{fontSize:"13px"}} />

            </span>
            <span className="pl-1 md:block hidden text-xs text-[#6f6f6f]">Due: Dec 8 2020</span>
            </div>
            </div>
            <div className="mt-4">
            ...
            <div className="flex mt-2.5 items-center justify-between">
               <UserAvatar/>
               <span className="text-xs text-[#6f6f6f] md:block hidden"> 3 Comments</span>
            </div>
        </div>
    )
}
