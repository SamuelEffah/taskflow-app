...
import { BoltOutlined, BookmarkAddOutlined, MoreVertOutlined } from "@mui/icons-material";
...
const ValidationColumn = (props: ColumnProps) => {
    ...
    <div className={`p-2 h-full bg-[#ffffff] w-full relative`}>
      <div className="flex justify-between items-center">
        <div className="flex bg-[#f9f9f9] rounded-sm p-1 w-max items-center  text-[10px]">
            <BookmarkAddOutlined className="text-red-500" style={{fontSize: "12px"}}/>
            <span className="px-2">Validation</span>
