    ...
    return (
        <div className='ml-10'>
              ...
              className="border-2 hover:bg-[#e2e2e2] p-1 px-4 rounded-full flex items-center">
                ...
                <span className="p-0 m-0 text-sm pl-1" >
                Schedule
            ...
            >
                <div style={{width:"500px", height:"650px"}} className='px-2 flex mt-7 flex-col justify-between outline-none bg-[#fff] relative rounded-md '>
                 ...
                 <h3 className='font-semibold text-lg pt-2'>Schedule</h3>
                    ...
                    <div className='mb-2 relative h-[280px] '>
                        ...
                        <span className=' bg-[#e1e1e1] ml-2 text-xs p-1 flex items-center justify-center rounded-full w-5 h-5'>3</span>
                        </div>
