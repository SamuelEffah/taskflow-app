...
const ProjectUserItem = ({user}: ProjectUserProps)=>{
    ...
    return (
        <div  onClick={handleUserOverview} className="flex cursor-pointer hover:bg-[#f4f4f4] border-b-[1px] py-[6px] px-3 border-[#f4f4f4]  items-start">
        <Avatar sx={{height: 24, width: 24}} alt={user.lastName} src={user.avatars[0]}/>
        <div className="flex flex-col ml-[5px] text-[11px] ">
